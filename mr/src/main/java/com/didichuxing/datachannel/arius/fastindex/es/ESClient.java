...
public class ESClient {
    ...
    public void createNewIndex(JSONObject setting) throws Exception {
        ...
        String ret = doHttpWithRetry(url, null, setting.toJSONString(), HttpUtil.HttpType.PUT, false, 5);
    ...
    public void forceMerge() throws Exception {
        ...
        String str = doHttpWithRetry(url, param, null, HttpUtil.HttpType.POST, false, 5);
