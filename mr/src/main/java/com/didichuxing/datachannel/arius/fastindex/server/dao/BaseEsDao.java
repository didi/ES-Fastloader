...
import com.didichuxing.datachannel.arius.fastindex.server.common.po.BasePo;
...
public class BaseEsDao {
     ...
     * 批量写入
     */
    public static boolean batchInsert(String indexName, String typeName, List<? extends BasePo> pos) {
     ...
     * 查询
     */
    public static String query(String indexName, String dsl) {
     ...
     * 删除一个key
     */
    public static void delete(String indexName, String typeName, String key) {
    ...
    public static String getUrlPrefix() {
        return "http://" + RemoteService.HOST;
    }
}
