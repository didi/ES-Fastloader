package com.didichuxing.datachannel.arius.fastindex.server.common.es;


import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.didichuxing.datachannel.arius.fastindex.server.common.es.mapping.ESVersion;
...
public class TemplateConfig {
    ...
    public JSONObject toJson() {
        ...
        if(mappings!=null && !mappings.isEmpty()) {
            root.put(MAPPINGS_STR, mappings.toJson(ESVersion.ES651));
        }
