...
import com.didichuxing.datachannel.arius.fastindex.server.common.po.FastIndexMappingPo;
...
public class FastIndexMappingEsDao extends BaseEsDao {
    ...
    public static boolean batchInsert(List<FastIndexMappingPo> poList) {
        return batchInsert(INDEX_NAME, TYPE_NAME, poList);
    }

    public static List<FastIndexMappingPo> getByindexName(String processIndex, int offset) {
        String dslFormat = "{\n" +
                "  \"sort\": [\n" +
                "    {\n" +
                "      \"reduceId\": {\n" +
    ...
    public static List<FastIndexMappingPo> getByindexNameAndSrcTag(String srcTag, String processIndex, int offset) {
        String dslFormat = "{\n" +
                "  \"sort\": [\n" +
                "    {\n" +
                "      \"reduceId\": {\n" +
    ...
    public static List<FastIndexMappingPo> getByindexName(String srcTag, String processIndex) {
